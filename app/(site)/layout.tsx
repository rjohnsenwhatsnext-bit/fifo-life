    ...
    <header style={{ borderBottom: "2px solid #e5e7eb", background: "#fff", position: "sticky", top: 0, zIndex: 50, boxShadow: "0 1px 4px rgba(0,0,0,0.05)" }}>
      <div className="site-header-inner" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <a href="/" style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ background: "#e8721c", color: "#fff", fontFamily: "system-ui, sans-serif", fontWeight: 900, fontSize: 18, padding: "4px 10px", borderRadius: 4, letterSpacing: "-0.02em" }}>FIFO</div>
      ...
      <div className="site-footer-grid" style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px 32px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 40 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            <div style={{ background: "#e8721c", color: "#fff", fontFamily: "system-ui, sans-serif", fontWeight: 900, fontSize: 16, padding: "3px 8px", borderRadius: 3 }}>FIFO</div>
        ...
        <div>
          ...
          <a href="/guides" style={{ display: "inline-block", background: "#e8721c", color: "#fff", fontFamily: "system-ui, sans-serif", fontWeight: 700, fontSize: 13, padding: "8px 16px", borderRadius: 6 }}>Grab the Free Guides →</a>
        </div>
      </div>
